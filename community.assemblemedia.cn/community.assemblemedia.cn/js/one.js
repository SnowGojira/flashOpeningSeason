	...
	var defaultsOne = {
                ...
                good: '饭圈小透明',
                perfect: '饭圈巨巨',
                worstText:'哎哟喂~你们命好生在繁 荣富强的今天而已！！哥 哥们当年追星不靠科技， 纯靠人肉奔走！！！我们 的毅力！我们我们的坚持！ 那才',
                goodText:'天啦噜~手滑错俩题就降 维成阿姨？！说我小透 明？说我不懂？！打榜 控评我从不缺席好吗？！！ 不求爱　　　　豆翻牌， 只求花　',
                perfectText:'我现在一定要保持镇定！！ 虽然内心已经无比的澎湃， 但谁让我是巨巨！！要酷要 酷要酷！！谁让我年纪轻轻 却如此优　　　秀！不行',    
...
//				imgUrls:'img/update/boy/1.png',
				imgcloud:'img/answerbox/dati.png',
				imgbacks:'img/update/social_back.png',
		 		titles: '好生活少不了好朋友，开始入社测试吧！', 
                comeOn: '',
                waits: ''
	};
	var init1 = {
		'questions': [
				...
				'worning':[
				{
				'falseTips':'"饭"=喜欢，"团饭"=全队都喜欢,斯外戈《明日之子》独秀赛道中的一员,明日的小哥哥都很棒!',
				'reply':'了解了,学长',	
